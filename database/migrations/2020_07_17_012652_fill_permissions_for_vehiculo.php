...
class FillPermissionsForVehiculo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehiculo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vehiculo',
            'admin.vehiculo.index',
            'admin.vehiculo.create',
            'admin.vehiculo.show',
            'admin.vehiculo.edit',
            'admin.vehiculo.delete',
            'admin.vehiculo.bulk-delete',
        ]);
